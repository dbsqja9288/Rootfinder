...
/** 답은 전부 아래 「어떻게 계산하나요」에 적힌 내용과 같다. 새 주장을 만들지 않는다. */
const FAQ = [
  {
    q: "촌수는 어떻게 세나요?",
    a: "나에서 공통 조상까지 올라간 걸음 수에, 공통 조상에서 상대까지 내려간 걸음 수를 더합니다. 형제는 부모까지 한 걸음씩 올라갔다 내려오니 2촌, 사촌은 할아버지까지 두 걸음씩이라 4촌입니다.",
  },
  {
    q: "대손이 뭔가요?",
    a: "시조로부터 몇 번째 세대인지를 말합니다. 시조를 1세로 놓고 아버지가 29대손이면 나는 30대손입니다. 족보나 집안 어른께 여쭤보면 알 수 있고, 항렬자로도 가늠할 수 있습니다.",
  },
  {
    q: "결과가 정확한가요?",
    a: "여기서 나오는 숫자는 '최대 몇 촌'이라는 상한선입니다. 두 사람의 파(派)가 어디서 갈렸는지 알 수 없어, 확실히 만나는 지점인 시조를 기준으로 계산하기 때문입니다. 두 집안이 시조보다 아래에서 갈렸다면 실제 촌수는 이보다 작습니다. 정확한 촌수는 양쪽 문중의 족보에서 공통 조상을 찾아야 알 수 있습니다.",
  },
  {
    q: "본관이 다르면 몇 촌인가요?",
    a: "본관이 다르면 시조가 다르므로 족보상 촌수를 셀 수 없습니다. 성씨가 같아도 본관이 다르면 혈연으로 이어져 있지 않은, 서로 다른 가문입니다.",
  },
  {
    q: "8촌 이내면 결혼할 수 없나요?",
    a: "우리 민법은 8촌 이내 혈족 사이의 혼인을 금지하고 있습니다(제809조 제1항). 다만 이 페이지의 촌수는 시조를 기준으로 한 어림값이라 법적·행정적 효력이 없습니다. 실제로 문제가 되는 상황이라면 족보로 공통 조상을 확인하고 법률 전문가와 상의하세요.",
  },
];
...
export default function KinPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <Faq
        title="촌수에 대해 자주 묻는 것"
        note="계산 근거를 숨기지 않습니다. 모르는 것은 모른다고 적습니다."
        items={FAQ}
      />
