...
export const CORE_SURNAMES: Surname[] = [
  {
    id: "kim",
    ko: "김",
    hanja: "金",
  ...
  },
  {
    ...
    clans: [
      ...
      { name: "영천 최씨", hanja: "永川", founder: "최한(崔漢)", note: "시조 최한은 고려 때 공을 세워 연산부원군(燃山府院君)에 봉해졌다고 전한다. 연산(燃山)은 영천의 별호다. 우리나라 최초로 화약을 만들어 진포대첩을 이끈 최무선(崔茂宣)과 그 아들 최해산이 이 가문에서 나왔다.", population: 21431 },
    ],
    figures: ["최치원(고운)", "최충(해동공자)", "최무선(화약 발명, 영천 최씨)", "최제우(동학 창시)"],
  },
  {
    id: "jung",
    ko: "정",
  ...
  },
  {
    ...
    clans: [
      ...
      { name: "칠원 윤씨", hanja: "漆原", founder: "윤시영(尹始榮)", note: "경남 함안 칠원이 본관.", population: 55000 },
      {
        ...
        hanja: "海平",
        founder: "윤군정(尹君正)",
        note: "고려 고종 때 수사공을 지낸 윤군정을 시조로 한다. 조선 선조 때 오음 윤두수와 월정 윤근수 형제가 나란히 정승·판서에 올랐고, 그 뒤로도 영의정 윤방 등을 배출해 서인(西人)의 핵심 가문으로 자리 잡았다.",
        population: 35000,
      },
      {
        name: "무송 윤씨",
        hanja: "茂松",
        founder: "윤양비(尹良庇)",
        note: "고려 때 호장을 지낸 윤양비를 시조로 하며, 전북 고창 무송현이 본관이다. 조선 세조 때 좌의정을 지낸 윤자운을 배출했다.",
        population: 20000,
      },
      {
        name: "남원 윤씨",
        hanja: "南原",
        founder: "윤위(尹威)",
        note: "고려 명종 때 남원 지역의 민란을 평정한 공으로 남원백에 봉해진 윤위를 시조로 한다.",
        population: 26000,
      },
    ],
    ...
    clans: [
      {
        ...
        hanja: "南陽",
        founder: "홍은열(洪殷悅)",
        note: "홍씨의 대다수를 차지한다. 시조를 홍은열로 하는 당홍(唐洪)과, 홍선행(洪先幸)을 시조로 하는 토홍(土洪) 두 계통이 같은 '남양'을 본관으로 쓰지만 서로 다른 가문이다.",
        population: 424000,
      },
